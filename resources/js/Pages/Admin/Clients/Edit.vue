...
<template>
    ...
    <div class="max-w-2xl">
        <PageHeader title="Editar Cliente" :subtitle="props.client.nombre">
            <Link :href="`/clients/${props.client.id}`">
        ...
        <Card variant="default" padding="lg">
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="flex items-center gap-4 pt-2">
                    ...
                    <Link :href="`/clients/${props.client.id}`" class="text-sm text-slate-400 hover:text-slate-200">Cancelar</Link>
                </div>
            </form>
        </Card>
    </div>
