...
<template>
    <div class="flex flex-col gap-1">
        <p v-if="!notes.length" class="text-sm text-slate-500 px-3 py-4 text-center">
        ...
        <Link
            ...
            class="group flex flex-col gap-1 px-4 py-3 rounded-lg border transition-colors cursor-pointer"
        ...
        >
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium text-slate-100 truncate">{{ note.titulo }}</span>
            </div>
            ...
            <div class="flex items-center gap-2 mt-0.5">
                <span v-if="note.folder" class="text-xs text-slate-600">{{ note.folder.nombre }}</span>
